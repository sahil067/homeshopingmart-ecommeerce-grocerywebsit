			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>01 day ago</i><span>ranchi <a href="#">http://sd.ds/13jklf#</a>
						Products are nice
						<a href="#">http://sd.ds/1389kjklf#</a>sam.</span></li>
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>02 day ago</i><span>jaipur <a href="#">http://fd.uf/56hfg#</a>
						Nice fruits and service
						<a href="#">http://fd.uf/56hfg#</a>nitin.</span></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
