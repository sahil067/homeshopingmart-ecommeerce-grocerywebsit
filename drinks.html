		...
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>01 day ago</i><span>bokaro <a href="#">http://sd.ds/13jklf#</a>
						nice service
						<a href="#">http://sd.ds/1389kjklf#</a>abhishek.</span></li>
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>02 day ago</i><span>dhanbad <a href="#">http://fd.uf/56hfg#</a>
						nice products
						<a href="#">http://fd.uf/56hfg#</a>appu.</span></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
			...
			<div class="wthree_footer_copy">
				<p>© 2016 Grocery Store. All rights reserved | Design by NRS TECH SOLUTION</p>
			</div>
		</div>
	</div>
<!-- //footer -->
