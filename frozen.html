		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					...
					<ol>
						<li>nice</li>
						<li>Fresh and good</li>
						<li>And price is also nice</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
					...
					<ol>
						<li>Chocolate are to yummy</li>
						<li>chips are spicy but i lovit</li>
						<li>thanks for this services </li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
		...
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>01 day ago</i><span>jodhpur <a href="#">http://sd.ds/13jklf#</a>
						lovit
						<a href="#">http://sd.ds/1389kjklf#</a>amit.</span></li>
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>02 day ago</i><span>ram nagar <a href="#">http://fd.uf/56hfg#</a>
						lovit
						<a href="#">http://fd.uf/56hfg#</a>anchal.</span></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
			...
			<div class="wthree_footer_copy">
				<p>© 2020 HomeShopingMart. All rights reserved | Design by Sahil</p>
			</div>
		</div>
	</div>
<!-- //footer -->
