		...
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>01 day ago</i><span>SAUDAGAR <a href="#">http://sd.ds/13jklf#</a>
						nice
						<a href="#">http://sd.ds/1389kjklf#</a>jonni</span></li>
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>02 day ago</i><span>Con numquam <a href="#">http://fd.uf/56hfg#</a>
						nice
						<a href="#">http://fd.uf/56hfg#</a>amit.</span></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
			...
			<div class="wthree_footer_copy">
				<p>© 2016 Home ShopingMart. All rights reserved | Design by Sahil</p>
			</div>
		</div>
	</div>
<!-- //footer -->
