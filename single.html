...
<html>
<head>
<title>HomeShopingMart | Single </title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list1">
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>01 day ago</i><span>chandigarh <a href="#">http://sd.ds/13jklf#</a>
						nice
						<a href="#">http://sd.ds/1389kjklf#</a>soniya.</span></li>
					<li><label class="fa fa-twitter" aria-hidden="true"></label><i>02 day ago</i><span>Chandigarh <a href="#">http://fd.uf/56hfg#</a>
						nice
						<a href="#">http://fd.uf/56hfg#</a>soniya.</span></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
